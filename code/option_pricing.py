"""
    Interface for Option Pricing algorithms.
"""
...
class Option_pricing(ABC):
    """
        @param  S_t       float   Price of the underlying asset.
        @param  K         float   Strike price.
        @param  r         float   Risk-free asset price
...
class Black_Scholes(Option_pricing):
    """ Class for computing the price of a European Call/Put.
    """
    def __init__(self, S_t, K, r, sigma, delta_t):
        """ Parameters used in Black-Scholes model.
        """
...
class Binomial_lattice(Option_pricing):
    """
        Lattice models in order to model the discrete time pricing of Call/Put options. It computes the American/European Call/Option. 
    """
